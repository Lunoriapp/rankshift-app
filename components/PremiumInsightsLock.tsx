...
export function PremiumInsightsLock({ onUnlock }: PremiumInsightsLockProps) {
  ...
  if (dismissed) {
    return (
      <section className="rounded-[1.8rem] border border-slate-200 bg-white px-5 py-5 text-sm text-slate-600 transition-colors duration-300 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.9rem] border border-slate-200 bg-white transition-colors duration-300 dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div
                key={item}
                className="rounded-[1.3rem] border border-slate-200 bg-slate-50 px-4 py-4 text-sm text-slate-600 blur-[1.5px] dark:border-slate-700 dark:bg-slate-950/70 dark:text-slate-300"
              >
                {item}
              </div>
            ))}
            ...
            <div className="w-full rounded-[1.6rem] border border-slate-200 bg-slate-50 p-6 dark:border-slate-700 dark:bg-slate-950/80">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  ...
                  className="flex-1 rounded-2xl border border-slate-300 px-4 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:border-slate-600 dark:hover:bg-slate-800"
                >
                  Maybe later
                </button>
              </div>
