...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed right-5 top-5 z-50 inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-200/80 bg-white/90 text-slate-700 shadow-[0_14px_30px_-18px_rgba(15,23,42,0.45)] backdrop-blur transition-all duration-300 hover:border-slate-300 hover:bg-white dark:border-slate-700/80 dark:bg-slate-900/90 dark:text-slate-100 dark:hover:border-slate-600 dark:hover:bg-slate-900"
    >
      <span
