...
export function LockedPremiumSection({
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.8rem] border border-slate-800 bg-slate-900">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-4">
            {[
              ...
              <div
                key={item}
                className="rounded-[1.3rem] border border-slate-800/90 bg-slate-950/70 px-4 py-4 text-sm text-slate-300 blur-[1.5px]"
              >
                {item}
              </div>
            ))}
            ...
            <div className="w-full rounded-[1.6rem] border border-slate-700 bg-slate-950/80 p-6 shadow-[0_24px_60px_-34px_rgba(2,6,23,0.85)] backdrop-blur">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  type="button"
                  onClick={onDismiss}
                  className="flex-1 rounded-2xl border border-slate-700 px-4 py-3 text-sm font-semibold text-slate-300 transition hover:border-slate-600"
                >
                  Maybe later
                </button>
              </div>
