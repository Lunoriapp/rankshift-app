...
exports.getExampleReportPayload = getExampleReportPayload;
const audit_fixes_1 = require("./audit-fixes");
...
const opportunities = [
    {
        ...
        matchedSnippet: "The page mentions local SEO audits, technical SEO support, and internal linking recommendations but does not always link users through to the best destination.",
        placementHint: 'Paragraph under "Where score gains still exist"',
        reason: "The page already introduces internal linking as a clear subtopic, so adding the destination page here would improve discovery and reinforce topical depth.",
        confidence: "High",
        confidenceScore: 91,
        status: "open",
    ...
    },
    {
        ...
        matchedSnippet: "Audit priorities, rewrite recommendations, and scan history are all saved so teams can track progress over time.",
        placementHint: 'List item under "Proof"',
        reason: "The source copy already promises historical tracking, so linking directly to the scan-history feature makes the workflow easier to understand.",
        confidence: "Medium",
        confidenceScore: 78,
        status: "open",
        category: "Internal linking",
...
const crawl = {
    ...
    description: "Audit a page, identify the biggest SEO gaps, and see what to fix next with saved score movement and internal link opportunities.",
    headings,
    images,
...
const score = {
    ...
    opportunity: {
        ...
        uplift: 7,
        label: "Strong",
        rationale: "This example page already has a solid structure, but stronger schema, image metadata, and contextual links would move it into a more competitive range.",
    },
    pillars: {
        meta: {
            score: 20,
...
const aiOutput = {
    ...
    rewrites: {
        ...
        description: "Audit any page, spot the biggest SEO gaps, and track what improved with saved reports, score movement, and internal linking recommendations.",
        h1: "Local SEO Audit Template for Growth Teams",
    },
};
const fixes = (0, audit_fixes_1.buildAuditFixes)(crawl, score, aiOutput);
function getExampleReportPayload() {
    const audit = {
        id: "101",
        user_id: null,
        project_id: null,
