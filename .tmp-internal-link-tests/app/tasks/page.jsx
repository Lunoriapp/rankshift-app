...
const task_system_1 = require("@/components/tasks/task-system");
exports.metadata = {
...
function TasksPage({ searchParams }) {
    return (<main className="min-h-screen bg-[#f6f7fb] px-4 py-4 text-slate-900 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-[1180px] flex-col gap-6 rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_24px_80px_-50px_rgba(15,23,42,0.35)] sm:p-8">
        ...
        <task_system_1.TaskSystem workspaceId={searchParams === null || searchParams === void 0 ? void 0 : searchParams.workspaceId} pageId={searchParams === null || searchParams === void 0 ? void 0 : searchParams.pageId} auditId={searchParams === null || searchParams === void 0 ? void 0 : searchParams.auditId}/>
      </div>
    </main>);
}
