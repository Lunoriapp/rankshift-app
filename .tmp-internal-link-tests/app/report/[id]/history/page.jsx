...
exports.default = ReportHistoryPage;
...
function ReportHistoryPage({ params }) {
    return (<>
      <auth_bootstrap_1.AuthBootstrap />
      <report_destination_workspace_1.ReportDestinationWorkspace reportId={params.id} section="history"/>
    </>);
}
