...
exports.InternalLinkingEmptyState = InternalLinkingEmptyState;
function InternalLinkingEmptyState({ hasActiveFilters, }) {
    if (hasActiveFilters) {
        return (<div className="rounded-[28px] border border-slate-200 bg-white/90 p-6 shadow-[0_14px_40px_rgba(15,23,42,0.06)] transition-colors duration-300 dark:border-slate-800 dark:bg-slate-900">
    ...
    return (<div className="rounded-[30px] border border-emerald-200/70 bg-[linear-gradient(180deg,rgba(240,253,250,0.98),rgba(255,255,255,0.98))] p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)] transition-colors duration-300 dark:border-emerald-900/70 dark:bg-[linear-gradient(180deg,rgba(6,78,59,0.32),rgba(15,23,42,0.98))] sm:p-7">
